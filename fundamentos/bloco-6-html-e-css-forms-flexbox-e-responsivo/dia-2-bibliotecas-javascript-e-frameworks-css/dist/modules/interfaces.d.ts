...
export interface FieldConfigInterface extends Partial<Pick<GlobalConfigInterface, 'errorFieldStyle' | 'errorFieldCssClass' | 'errorLabelStyle' | 'errorLabelCssClass' | 'successFieldStyle' | 'successFieldCssClass' | 'successLabelStyle' | 'successLabelCssClass' | 'tooltip'>> {
